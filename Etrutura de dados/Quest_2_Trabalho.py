...
class ListaEncadeadaSimples:
    def __init__(self):
        self.head = None  # Inicializa o head da lista encadeada como None
    ...
    def inserir(self, sigla, nomeEstado):
        ...
        if self.head is None:
            ...
            nodo.proximo = self.head  # Caso contrário, o novo nodo aponta para o head atual
            self.head = nodo  # E o head é atualizada para o novo nodo

    def imprimir(self):
        temp = self.head  # Começa no head da lista
...
class TabelaHash:
    ...
    def hashFunc(self, k):
        if k == "DF":
            return 7  # Se a sigla é "DF", retorna posição 7
...
# Programa principal
Teste = TabelaHash()  # Cria a tabela hash
